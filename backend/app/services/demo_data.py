...
DEMO_ZONES = {
    "ZONE_A": {
        "name": "Zone A",
        "scenario": "healthy",
        "crop_type": "Tomato (Abhinav F1)",
        "growth_stage": "Vegetative Stage",
        "growth_stage_hi": "वानस्पतिक बढ़वार",
        "growth_stage_mr": "शाकीय वाढ",
        "stage_day": 34,
        "gdd_accumulated": 490,
        "yield_risk_pct": 5.0,
        "soil_moisture": 45.0,
    ...
    "ZONE_B": {
        ...
        "crop_type": "Tomato (Abhinav F1)",
        "growth_stage": "Flowering & Anthesis",
        "growth_stage_hi": "फूल आने की अवस्था",
        "growth_stage_mr": "फुलोरा अवस्था",
        "stage_day": 52,
        "gdd_accumulated": 820,
        "yield_risk_pct": 18.0,
        "soil_moisture": 24.0,
    ...
    "ZONE_C": {
        ...
        "crop_type": "Tomato (Abhinav F1)",
        "growth_stage": "Fruit Formation",
        "growth_stage_hi": "फल विकास अवस्था",
        "growth_stage_mr": "फळ धारणा",
        "stage_day": 74,
        "gdd_accumulated": 1140,
        "yield_risk_pct": 28.0,
        "soil_moisture": 38.0,
